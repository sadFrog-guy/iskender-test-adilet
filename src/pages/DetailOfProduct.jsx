    ...
    <>
      <div className='detail_page'>
        <div className='about_product'>
          <div className='left'>
            ...
            <div className='second-c'>
              <img src={img} alt='' className='second-c__image' />
              <div className='heart'>
                <Heart fill='#3286C2' />
              </div>
            </div>
          ...
          <div className='third-c'>
            <h2>
              Зеркало Анталия (3 полки) (Дуб Крафт Бел) 500*700 (Four) Стандарт
              Анталия (3 полки) (Дуб Крафт Бел)
            </h2>
            <p>Комплекты:</p>
            <div className='complects'>
              {complects.map((el, index) => (
                <div key={index} className='complect' onClick={() => Check()}>
                  <div className={checked ? 'checked' : 'check'}></div>
                  <img src={el.img} alt='' className='c-img' />
        ...
        <div className='description'>
          <h2>Описание:</h2>
          <p>
            У нас появились совершенно новые модели гарнитуров и кофейных
            столов, чтобы сделать вашу гостиную еще более комфортной и
            элегантной. Мы предлагаем разнообразные стили и цветовые решения,
            чтобы подчеркнуть ваш уникальный вкус.У нас появились совершенно
            новые модели гарнитуров и кофейных столов, чтобы сделать вашу
            гостиную еще более комфортной и элегантной. У нас появились
            совершенно новые модели гарнитуров и кофейных столов, чтобы сделать
            вашу гостиную еще более комфортной и элегантной.
          </p>
        </div>
